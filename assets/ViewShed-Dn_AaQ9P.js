import{r as h,j as l,c as E}from"./index-Cet_-lYO.js";import{d as S,F as T,c as f,e as u,f as i,g as D,P as A,h as g,i as b,j as L,k as P,E as R,l as B,T as U,M as O,W as V,V as W}from"./tileset3d-DI-al1eO.js";import{u as k}from"./useTileset-7TPFeHGw.js";import{B as x}from"./button-CmnNIslI.js";import"./index-DfwWoX0C.js";import"./Compact-C3dCnsyP.js";function d(n,e){return S("defaultValue","defaultValue has been deprecated and will be removed in Cesium 1.134. Use the nullish coalescing operator instead: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing"),n??e}Object.defineProperty(d,"EMPTY_OBJECT",{get:function(){return S("defaultValue.EMPTY_OBJECT","defaultValue.EMPTY_OBJECT has been deprecated and will be removed in Cesium 1.134. Use Frozen.EMPTY_OBJECT instead"),T.EMPTY_OBJECT}});const F=`
...
}`,p={cameraPosition:new f,viewPosition:new f,viewAreaColor:new u(0,1,0),shadowAreaColor:new u(1,0,0),alpha:.5,frustum:!0,size:4096,depthBias:2e-12};class j{constructor(e,t={}){this.viewer=e,this._isDestroyed=!1,this.cameraPosition=typeof t.cameraPosition.getValue=="function"?t.cameraPosition:new f(t.cameraPosition),this.viewPosition=typeof t.viewPosition.getValue=="function"?t.viewPosition:new f(t.viewPosition),this.viewAreaColor=d(t.viewAreaColor,p.viewAreaColor),this.shadowAreaColor=d(t.shadowAreaColor,p.shadowAreaColor),this.alpha=d(t.alpha,p.alpha),this.size=d(t.size,p.size),this.frustum=d(t.frustum,p.frustum),this.depthBias=d(t.depthBias,p.depthBias),this.preUpdateListener=null,this.cameraPosition&&this.viewPosition&&this._addToScene()}get _getVectors(){let e=this.cameraPosition.getValue(this.viewer.clock.currentTime),t=this.viewPosition.getValue(this.viewer.clock.currentTime),a=Number(i.distance(t,e).toFixed(1));if(a>1e4){let o=1-1e4/a;e=i.lerp(e,t,o,new i)}return{positionVector:e,viewVector:t}}destroy(){this.preUpdateListener&&(this.viewer.scene.preUpdate.removeEventListener(this.preUpdateListener),this.preUpdateListener=null),this.viewShadowMap&&(this.viewShadowMap.dispose(),this.viewShadowMap=null),this.postProcess&&(this.viewer.scene.postProcessStages.remove(this.postProcess),this.postProcess=null),this.viewer.scene.primitives.remove(this);for(let e in this)this.hasOwnProperty(e)&&delete this[e];this._isDestroyed=!0}isDestroyed(){return this._isDestroyed}_addToScene(){this._createShadowMap(),this._addPostProcess(),this.viewer.scene.primitives.add(this)}_createShadowMap(e){let{positionVector:t,viewVector:a}=this._getVectors;const o=Number(i.distance(a,t).toFixed(1));if(o>1e4){const m=1-1e4/o;t=i.lerp(t,a,m,new i)}const s=this.viewer.scene,r=new D(s);r.position=t,r.direction=i.subtract(a,t,new i(0,0,0)),r.up=i.normalize(t,new i(0,0,0)),r.frustum=new A({fov:g.toRadians(26),aspectRatio:s.canvas.clientWidth/s.canvas.clientHeight,near:.1,far:o}),e?this.viewShadowMap._lightCamera.position=t:this.viewShadowMap=new b({lightCamera:r,enable:!0,isPointLight:!1,isSpotLight:!0,cascadesEnabled:!1,context:s.context,size:this.size,pointLightRadius:o,fromLightSource:!1,maximumDistance:o}),this.viewShadowMap.normalOffset=!0,this.viewShadowMap._terrainBias.depthBias=0}_addPostProcess(){const e=this,t=this.viewShadowMap,a=t._isPointLight?t._pointBias:t._primitiveBias;this.postProcess=this.viewer.scene.postProcessStages.add(new L({fragmentShader:F,uniforms:{view_distance:function(){return e.distance},viewArea_color:function(){return e.viewAreaColor},shadowArea_color:function(){return e.shadowAreaColor},percentShade:function(){return e.alpha},shadowMap:function(){return t._shadowMapTexture},_shadowMap_cascadeSplits:function(){return t._cascadeSplits},_shadowMap_cascadeMatrices:function(){return t._cascadeMatrices},_shadowMap_cascadeDistances:function(){return t._cascadeDistances},shadowMap_matrix:function(){return t._shadowMapMatrix},shadowMap_camera_positionEC:function(){return t._lightPositionEC},shadowMap_camera_directionEC:function(){return t._lightDirectionEC},cameraPosition_WC:function(){return e.viewer.camera.positionWC},viewPosition_WC:function(){return e.viewPosition.getValue(e.viewer.clock.currentTime)},shadowMap_camera_up:function(){return t._lightCamera.up},shadowMap_camera_dir:function(){return t._lightCamera.direction},shadowMap_camera_right:function(){return t._lightCamera.right},ellipsoidInverseRadii:function(){let o=e.viewer.scene.globe.ellipsoid.radii;return new i(1/o.x,1/o.y,1/o.z)},shadowMap_texelSizeDepthBiasAndNormalShadingSmooth:function(){var o=new B;return o.x=1/t._textureSize.x,o.y=1/t._textureSize.y,P.fromElements(o.x,o.y,this.depthBias,a.normalShadingSmooth,this.combinedUniforms1)},shadowMap_normalOffsetScaleDistanceMaxDistanceAndDarkness:function(){return P.fromElements(a.normalOffsetScale,t._distance,t.maximumDistance,t._darkness,this.combinedUniforms2)},exclude_terrain:function(){return e.viewer.terrainProvider instanceof R}}})),this.preUpdateListener&&this.viewer.scene.preUpdate.removeEventListener(this.preUpdateListener),this.preUpdateListener=()=>{this.viewShadowMap._shadowMapTexture?this.postProcess.enabled=!0:this.postProcess.enabled=!1},this.viewer.scene.preUpdate.addEventListener(this.preUpdateListener)}update(e){this._createShadowMap(!0),e.shadowMaps.push(this.viewShadowMap)}destroy(){this.preUpdateListener&&this.viewer.scene.preUpdate.removeEventListener(this.preUpdateListener),this.viewer.scene.postProcessStages.remove(this.postProcess);for(let e in this)this.hasOwnProperty(e)&&delete this[e]}get size(){return this._size}set size(e){this._size=e}get depthBias(){return this._depthBias}set depthBias(e){this._depthBias=e}get cameraPosition(){return this._cameraPosition}set cameraPosition(e){this._cameraPosition=e}get viewPosition(){return this._viewPosition}set viewPosition(e){this._viewPosition=e}get frustum(){return this._frustum}set frustum(e){this._frustum=e}get distance(){return this._distance}set distance(e){this._distance=e}get viewAreaColor(){return this._viewAreaColor}set viewAreaColor(e){this._viewAreaColor=e}get shadowAreaColor(){return this._shadowAreaColor}set shadowAreaColor(e){this._shadowAreaColor=e}get alpha(){return this._alpha}set alpha(e){this._alpha=e}}const _={longitude:7.201578,latitude:51.256565,height:363},N=(n,{heading:e,pitch:t,range:a})=>{const o=U.eastNorthUpToFixedFrame(n),s=new i(Math.cos(t)*Math.cos(e),Math.cos(t)*Math.sin(e),Math.sin(t)),r=i.multiplyByScalar(s,a,new i);return O.multiplyByPointAsVector(o,r,new i)},v=i.fromDegrees(_.longitude,_.latitude,_.height),I=N(v,{heading:g.toRadians(30),pitch:g.toRadians(-25),range:200}),C=i.add(v,I,new i),K=()=>{const n=h.useRef(null),e=h.useRef(null),t=h.useRef(null),{tilesetRef:a,tilesetReady:o}=k(V.url,e.current),s=h.useRef(null),r=h.useRef(null);h.useEffect(()=>((async()=>{try{if(n.current){const c=new W(n.current,E);e.current=c,s.current=c.entities.add({position:C,point:{pixelSize:10,color:u.LIME}}),r.current=c.entities.add({position:v,point:{pixelSize:10,color:u.YELLOW}}),c.zoomTo([r.current,s.current])}}catch(c){console.error("Initialization error:",c)}})(),()=>{e.current&&e.current.destroy()}),[]),h.useEffect(()=>{e.current.scene&&o&&(t.current=new j(e.current,{cameraPosition:v,viewPosition:C,viewAreaColor:new u(.5,1,.5),shadowAreaColor:new u(.2,.2,.2),alpha:.5,frustum:!0,size:1024}),e.current.scene.requestRender())},[o]);const m=()=>{if(e.current&&r.current&&s.current){const w=r.current.position.getValue(e.current.clock.currentTime),c=s.current.position.getValue(e.current.clock.currentTime),z=i.normalize(i.subtract(c,w,new i),new i),y=i.normalize(w,new i);e.current.camera.flyTo({destination:w,orientation:{direction:z,up:y},duration:2})}},M=()=>{e.current&&e.current.zoomTo([r.current,s.current])};return l.jsxs(l.Fragment,{children:[l.jsx("div",{ref:n,style:{width:"100%",height:"100vh"}}),";",l.jsxs("div",{style:{position:"absolute",bottom:10,right:10,left:10,padding:"10px",background:"rgba(255, 255, 255, 0.85)"},children:[l.jsx(x,{onClick:M,children:"go to Overview "}),l.jsx(x,{onClick:m,children:"view from Camera "})]})]})};export{K as default};
